...
Параллелограммы из файлов coil_2 - coil_6  обработать не удалось, т.к. те содержат стороны со сторонами со слишком большим разрывом относительно других сторон. 
